...
#include "YelpDataStore.h"

typedef void (^TokenPendingTask)(NSString *token);

static NSString const * kGrantType = @"client_credentials";
static NSString const * kClient_id = @"tOtUNAIW3zFGEXvNYSMChQ";
static NSString const * kClient_secret = @"1JtufKbUMuHc2wo3fIe6THeEr6sD53mkE0Jt588CQuhVYLLs5Fwtm84rB7eZnKLA";
